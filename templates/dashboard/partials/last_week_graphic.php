<div class="container-fluid p-0 m-0 col-xl-12" id="summary_last_week" style="display: block;">
...
<script>
(function() {
    var jsonData = <?php echo $jsonChartData; ?>;
    ...
    Highcharts.chart('chart-last-week', {
        chart: { type: 'column' },
        title: { text: 'Last Week Technician Assignment', align: 'left' },
